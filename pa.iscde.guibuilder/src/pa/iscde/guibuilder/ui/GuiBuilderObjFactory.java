...
class GuiBuilderObjFactory {
	...
	public ComponentInComposite createComponentFamilyObject(GuiLabels.GUIBuilderComponent componentType, Point position,
	...
	public WidgetInComposite createComponentFamilyObjectWidget(WidgetInComposite widget, Point position,
			Canvas canvas) {
		String label = null;
		try {
